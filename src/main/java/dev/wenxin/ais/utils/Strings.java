...
public final class Strings {
    ...
    public static String[] addStringToArray(String[] array, String str) {
        if (dev.wenxin.ais.utils.Objects.isEmpty(array)) {
    ...
    public static String[] concatenateStringArrays(String[] array1, String[] array2) {
        if (dev.wenxin.ais.utils.Objects.isEmpty(array1)) {
            return array2;
        }
        if (dev.wenxin.ais.utils.Objects.isEmpty(array2)) {
            return array1;
        }
    ...
    public static String collectionToDelimitedString(Collection<?> coll, String delim, String prefix, String suffix) {
        if (dev.wenxin.ais.utils.Collections.isEmpty(coll)) {
            return "";
        }
        StringBuilder sb = new StringBuilder();
    ...
    public static String arrayToDelimitedString(Object[] arr, String delim) {
        if (dev.wenxin.ais.utils.Objects.isEmpty(arr)) {
            return "";
        }
        if (arr.length == 1) {
